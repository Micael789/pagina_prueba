...
export default function QRStatusManager() {
  ...
  const handleSubmit = () => {
    ...
    alert(`Datos registrados correctamente para la unidad: ${unitId}`)
  ...
  return (
    <>
      <Head>
        <title>Mobilet - Unidad {unitId}</title>
        <meta name="description" content={`Gestión de estatus para unidad ${unitId}`} />
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="bg-white rounded-2xl p-6 container-shadow mb-6">
              ...
              {unitId && (
                <div className="mt-3 px-4 py-2 bg-blue-100 rounded-lg">
                  <p className="text-mobilet-blue font-semibold">Unidad: {unitId}</p>
                </div>
              )}
            </div>
